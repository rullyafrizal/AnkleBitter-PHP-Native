                ...
                <div class="row mb-2" data-aos="fade-up" data-aos-delay="200" id="locations">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="recipient" required name="penerima"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="address_one">Address</label>
                            <input type="text" class="form-control" id="address_one" required name="address"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="kodepos">Postal Code</label>
                            <input type="text" class="form-control" id=kodepos" required name="kodepos"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
